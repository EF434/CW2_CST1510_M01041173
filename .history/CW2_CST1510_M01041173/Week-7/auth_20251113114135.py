...
def register_user(username: str, password: str, role: str = "user") -> tuple[bool, str, str]:
    ...
    Challenge 2.
    Register a user with a specific role (user, admin,
analyst).
...
def main():
    print("Welcome to the Week 7 Authentication System!".center(50))

    while True:
        display_menu()
        choice = input("Select an option (1-3): ".center(60)).strip()
