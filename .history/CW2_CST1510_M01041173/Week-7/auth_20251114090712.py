    ...
    while True:
        ...
        if choice == '1':
            ...
            while password_attempts > 0:
                ...
                print("Error: Maximum password attempts reached. Registration failed.")
                break
            break
        else:
            print("Error: Maximum username attempts reached. Registration failed.")
            ...
            if login_user(username, password):
                ...
                print(f"🛡️ Your session token: {token}")
