...
def login_user(username, password):
    ...
    if failed_attempts[username] >= MAX_ATTEMPTS:
        print("🚫 Account is locked. Please wait before trying again.")
        return False
        ...
        # -------------------- Login --------------------
            ...
            while login_attempts > 0:
                ...
                if login_status is True:
                    ...
                    login_attempts -= 1
                    add_failed_attempt(username)
                    if username in failed_attempts and failed_attempts[username] < MAX_ATTEMPTS and login_attempts > 0:
                      print(login_status)
                    elif username in failed_attempts and failed_attempts[username] >= MAX_ATTEMPTS:
                # Lockout handled inside add_failed_attempt
                break
                    else:
