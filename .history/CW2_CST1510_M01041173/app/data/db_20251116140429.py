# db.py contains functions related to database operations
...
# Define paths
# -------------------------------
FILE_ROOT = Path(__file__).resolve().parents[2]  # Project root folder
DATA_DIR = FILE_ROOT / "DATA" # Path to DATA folder
