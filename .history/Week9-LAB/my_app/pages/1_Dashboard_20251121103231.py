...
# ----------------------------
ROOT_DIR = Path(r"C:\CST1510\CW2_CST1510_M01041173")  # Root of your project containing 'app'
DATA_DIR = ROOT_DIR / "app" / "data"                   # Path to data folder
DB_PATH = DATA_DIR / "intelligence_platform.db"        # Database path

# Add ROOT_DIR to sys.path so Python can find 'app'
...
print(f"Root folder: {ROOT_DIR.resolve()}")
