...
# ----------------------------
ROOT_DIR = Path(r"C:\CST1510\CW2_CST1510_M01041173")
DATA_DIR = ROOT_DIR / "app" / "data"
DB_PATH = (DATA_DIR / "intelligence_platform.db").resolve()
...
if selected_domain == "Cybersecurity":
    ...
    if choice == "➕ Add Item":
        ...
        with st.form("ticket_form"):
            ...
            created_date = st.date_input("Created Date", datetime.date.today())
