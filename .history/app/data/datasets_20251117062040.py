...
def insert_dataset(conn, dataset_name, source, category, last_updated,
    ...
    Args:
        ...
        source: Where the dataset originates from (API, CSV, External vendor, etc.)
        category: Dataset type (Security logs, HR data, Finance records, etc.)
        last_updated: Last time this dataset was updated
        record_count: Number of records in the dataset (INTEGER)
        file_size_mb: Dataset size in megabytes (FLOAT)
        created_at: Timestamp for when it was added (optional)
