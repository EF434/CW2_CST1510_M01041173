...
def get_top_recent_updates(conn):
    """
    Retrieve the 3 most recently updated datasets.
    Useful for finding active or maintained datasets.
    """
    query = """
    SELECT dataset_name, category, last_updated, record_count, file_size_mb
    FROM dataset
