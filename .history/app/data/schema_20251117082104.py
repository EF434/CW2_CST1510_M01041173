# schema.py: Defines 4 functions to create database tables and ensure proper structure
...
def create_cyber_incidents_table(conn):
    ...
    try: 
        ...
        with conn:
            ...
            print("🛡️ 'cyber_incidents' table created successfully!")
...
# --------------------------------------------------------------------
# create_users_table() function to create datasets_metadata table
# --------------------------------------------------------------------
...
# --------------------------------------------------------------------
# create_it_tickets_table function to create datasets_metadata table
# --------------------------------------------------------------------
# --- Implement the following functions similarly to create_users_table()
...
def create_all_tables(conn):
    ...
    Args:
        conn: Database connection object
    """
    # Call each table creation function
