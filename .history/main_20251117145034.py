...
from app.services.user_service import register_user, login_user, create_session, migrate_users_from_file, check_password_strength
            ...
            if choice == 1:
                ...
                while username_attempts > 0:
                    ...
                    while password_attempts > 0:
                        ...
                        # Ask for confimation if passwrod strength is moderate
                        if msg.startswith("Moderate"):
                            user_selection = input("Do you want to proceed with this password? (y/n): ").strip().lower()
                            if user_selection != 'y':
                                password_attempts -= 1
                                continue
