...
def run_comprehensive_tests():
    ...
    print("1) User Authentication & CRUD")
    print("2) Cyber_incidents CRUD")
    print("3) Datasets_metadata CRUD")
    print("4) IT_tickets CRUD")
    print("="*60)

    option = input("Enter your selection (1-4): ")
    
    conn = connect_database()
    
    if # Test 1: Authentication
