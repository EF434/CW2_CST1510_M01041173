...
# Add the 'C:\CST1510\CW2_CST1510_M01041173' folder to Python path
...
if selected_domain == "Cybersecurity":
    ...
    if choice == menu[0]:
        ...
        # Display existing incidents in a beautiful table
        incidents_df = get_all_incidents(conn)
        if incidents_df.empty:
            st.info("No incidents found in the system yet.")
        else:
        # Optionally, format date column
