...
PROJECT_ROOT = Path(__file__).resolve().parent.parent  # C:\CST1510\CW2_CST1510_M01041173
DATA_DIR = PROJECT_ROOT / "DATA"

cyber_file = DATA_DIR / "cyber_incidents.csv"
tickets_file = DATA_DIR / "it_tickets.csv"
datasets_file = DATA_DIR / "datasets_metadata.csv"

# Load CSVs
load_all_csv_data(conn, cyber_file, "cyber_incidents")
load_all_csv_data(conn, tickets_file, "it_tickets")
load_all_csv_data(conn, datasets_file, "datasets_metadata")
