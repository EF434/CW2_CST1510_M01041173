...
# ------------------- SESSION STATE -------------------
if "logged_in" not in st.session_state: st.session_state.logged_in = False if "username" not in st.session_state: st.session_state.username = "" if "df" not in st.session_state: st.session_state.df = pd.DataFrame() # empty placeholder if "domain" not in st.session_state: st.session_state.domain = "
