...
actions = st.sidebar.selectbox("Choose Action", ["● View Records", "● Add New Record", "● Update", "● Delete"])
...
"● View Records", "● Add New Record", "● Update Record", "● Delete Record"
# ------------------- ACTION ROUTING -------------------
if actions == "● View Records":
    st.subheader(f"📄 {domain} Records")
    st.dataframe(df, use_container_width=True)

elif actions == "● Add New Record":
    add_record_form(fields, insert_func, conn)

elif actions == "● Update Record":
    update_record_form(df, update_func, fields, conn)

elif actions == "● Delete Record":
