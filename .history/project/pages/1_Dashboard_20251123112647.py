...
# Metrics
threats_detected = len(df)
vulnerabilities = df[df['severity'] == 'Critical'].shape[0]
incidents = df[df['status'] == 'Open'].shape[0]

# Threat distribution
threat_data = df['incident_type'].value_counts().to_dict()
