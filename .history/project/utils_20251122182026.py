...
def add_new_record():
    df = pd.DataFrame(get_all_incidents(conn)) df_filtered = view_records(df, "Cybersecurity") add_new_record(insert_incident, ["title", "severity", "status", "description", "reported_by"], "Cybersecurity") update_delete_record(update_incident_status, delete_incident, df_filtered, ["title", "severity", "status", "description", "reported_by"], "Cybersecurity")
