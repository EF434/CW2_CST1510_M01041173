...
def add_new_record():
    ...
    add_new_record(insert_incident, ["title", "severity", "status", "description", "reported_by"], "Cybersecurity") update_delete_record(update_incident_status, delete_incident, df_filtered, ["title", "severity", "status", "description", "reported_by"], "Cybersecurity")
