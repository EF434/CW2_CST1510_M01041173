        ...
        if table_name == "cyber_incidents":
            ...
            for field, value in record.items():
                if field == key:
                    ...
                    current_sev = value if value in severity_options else "Medium"
                    updated[field] = st.selectbox("Severity", severity_options, index=severity_options.index(current_sev))
                else:
