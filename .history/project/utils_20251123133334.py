...
def view_records(conn, table_name):
    if table_name == "cyber_incidents":
        ...
        st.markdown('<div class="cyber-sub">🔒 {table_name}</div>', unsafe_allow_html=True)
        ...
        st.markdown('<div class="table-header">📊 Data Science Datasets</div>', unsafe_allow_html=True)66.3333333333333333333888888888
